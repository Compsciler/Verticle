...
function App() {
  ...
  const newSiteLink = 'https://verticle.netlify.app'
  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <div className="pt-2 px-1 pb-8 md:max-w-7xl w-full mx-auto sm:px-6 lg:px-8 flex flex-col grow place-items-center">
